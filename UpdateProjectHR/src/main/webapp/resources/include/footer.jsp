...
<footer style="background-color: white; height: 50px; display: flex; align-items: center; padding-left: 18px;">
	...
	<strong>&copy; Copyright 2024 <a href="http://almsaeedstudio.com">BSWILL COMPANY</a>.
	</strong> &nbsp &nbsp All rights reserved.
</footer>
	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="control-sidebar-settings-tab">
			<form method="post">
				...
				<div class="form-group">
					<label class="control-sidebar-subheading"> Delete chat history <a href="javascript::;" class="text-red pull-right">
